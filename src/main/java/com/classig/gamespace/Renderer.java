 ...
 * Отвечает за все операции рисования, поддерживая принцип единственной ответственности(Srp) и принцип инверсии зависимостей(Dip) (зависит от абстракции GraphicsContext).
 */
